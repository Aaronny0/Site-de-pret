            ...
            <div>
              <nav aria-label="Fil d'Ariane" style={{ marginBottom: "1.5rem" }}>
                <ol style={{ display: "flex", gap: "0.5rem", listStyle: "none", fontSize: "0.8rem", color: "rgba(255,255,255,0.5)" }}>
                  ...
                  <li><ChevronRight size={12} style={{ display: "inline" }} /></li>
                  <li style={{ color: "#6EE7B7" }}>Prêt Auto & Moto</li>
                </ol>
              </nav>
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1rem" }}>
                ...
                <span className="badge badge-success" style={{ background: "rgba(16, 185, 129, 0.4)", color: "white" }}>Véhicules propres</span>
              </div>
              <h1 style={{ color: "white", fontFamily: "var(--font-display)", fontSize: "clamp(1.75rem, 4vw, 2.75rem)", marginBottom: "1rem" }}>
                Financer votre nouveau véhicule
              </h1>
              <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "1.1rem", lineHeight: "1.7", maxWidth: "550px" }}>
                Neuf ou occasion, hybride ou thermique. Bénéficiez d'un prêt affecté protégeant votre achat avec des conditions exceptionnelles pour les véhicules 100% électriques.
              </p>
            </div>
             <div style={{ background: "rgba(255,255,255,0.08)", borderRadius: "var(--radius-xl)", padding: "2rem", textAlign: "center", minWidth: "220px", backdropFilter: "blur(10px)" }}>
              <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.85rem", marginBottom: "0.25rem" }}>Véhicules électriques dès</p>
              ...
              <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.75rem", marginTop: "0.25rem" }}>TAEG fixe</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "var(--color-bg)", padding: "3rem 0 5rem" }}>
        <div className="container">
           <div style={{ display: "flex", justifyContent: "center" }}>
             <Link href="/simulateur" className="btn btn-primary btn-lg" style={{ background: "#10B981", border: "none" }}>
               Calculer mes mensualités Auto
               <ArrowRight size={18} />
             </Link>
           </div>
        </div>
