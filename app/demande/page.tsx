...
const loanTypes = [
  "Prêt Personnel", "Prêt Immobilier", "Prêt Professionnel",
  "Rachat de Crédit", "Prêt Travaux", "Prêt Auto",
];

const statusOptions = [
  "CDI", "CDD", "Indépendant / Auto-entrepreneur", "Fonctionnaire",
  "Retraité(e)", "Sans emploi", "Autre",
];
