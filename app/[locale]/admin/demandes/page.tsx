...
const demoDemandes = [
  {
    ...
    // Step 4 — Documents
    documents: [
      { id: 'identity', label: "Pièce d'identité", name: 'DNI_Carlos_Garcia.pdf', type: 'PDF', size: '1.2 Mo', uploaded_at: '2026-04-09' },
      { id: 'salary', label: 'Justificatif de revenus', name: 'nominas_2026_Q1.pdf', type: 'PDF', size: '890 Ko', uploaded_at: '2026-04-09' },
      { id: 'bank', label: 'Relevés bancaires', name: 'extractos_bancarios.pdf', type: 'PDF', size: '2.1 Mo', uploaded_at: '2026-04-09' },
      { id: 'domicile', label: 'Justificatif de domicile', name: 'factura_iberdrola.pdf', type: 'PDF', size: '450 Ko', uploaded_at: '2026-04-09' },
      { id: 'rib', label: 'RIB', name: 'IBAN_CaixaBank.pdf', type: 'PDF', size: '120 Ko', uploaded_at: '2026-04-09' },
    ],
  ...
  },
  {
    ...
    documents: [
      { id: 'identity', label: "Pièce d'identité", name: 'DNI_Ana_Rodriguez.pdf', type: 'PDF', size: '1.1 Mo', uploaded_at: '2026-04-08' },
      { id: 'salary', label: 'Justificatif de revenus', name: 'nominas_deloitte.pdf', type: 'PDF', size: '1.5 Mo', uploaded_at: '2026-04-08' },
      { id: 'bank', label: 'Relevés bancaires', name: 'extractos_BBVA.pdf', type: 'PDF', size: '2.8 Mo', uploaded_at: '2026-04-08' },
      { id: 'domicile', label: 'Justificatif de domicile', name: 'recibo_agua.pdf', type: 'PDF', size: '380 Ko', uploaded_at: '2026-04-08' },
      { id: 'rib', label: 'RIB', name: 'IBAN_BBVA.pdf', type: 'PDF', size: '98 Ko', uploaded_at: '2026-04-08' },
      { id: 'other', label: 'Document complémentaire', name: 'compromis_vente_apt.pdf', type: 'PDF', size: '3.2 Mo', uploaded_at: '2026-04-08' },
    ],
  ...
  },
  {
    ...
    documents: [
      { id: 'identity', label: "Pièce d'identité", name: 'DNI_Miguel_Torres.pdf', type: 'PDF', size: '1.0 Mo', uploaded_at: '2026-04-07' },
      { id: 'salary', label: 'Justificatif de revenus', name: 'nominas_junta.pdf', type: 'PDF', size: '750 Ko', uploaded_at: '2026-04-07' },
      { id: 'bank', label: 'Relevés bancaires', name: 'extractos_unicaja.pdf', type: 'PDF', size: '1.9 Mo', uploaded_at: '2026-04-07' },
      { id: 'domicile', label: 'Justificatif de domicile', name: 'recibo_endesa.pdf', type: 'PDF', size: '320 Ko', uploaded_at: '2026-04-07' },
      { id: 'rib', label: 'RIB', name: 'IBAN_Unicaja.pdf', type: 'PDF', size: '105 Ko', uploaded_at: '2026-04-07' },
      { id: 'other', label: 'Document complémentaire', name: 'factura_proforma_seat.pdf', type: 'PDF', size: '680 Ko', uploaded_at: '2026-04-07' },
    ],
  ...
  },
  {
    ...
    documents: [
      { id: 'identity', label: "Pièce d'identité", name: 'DNI_Isabel_Martin.pdf', type: 'PDF', size: '980 Ko', uploaded_at: '2026-04-06' },
      { id: 'salary', label: 'Justificatif de revenus', name: 'nominas_NH.pdf', type: 'PDF', size: '650 Ko', uploaded_at: '2026-04-06' },
      { id: 'bank', label: 'Relevés bancaires', name: 'extractos_santander.pdf', type: 'PDF', size: '2.4 Mo', uploaded_at: '2026-04-06' },
    ],
    consents: { cgu: true, privacy: true, accuracy: true, processing: true, marketing: false },
  ...
  },
  {
    ...
    documents: [
      { id: 'identity', label: "Pièce d'identité", name: 'DNI_Pedro_Sanchez.pdf', type: 'PDF', size: '1.1 Mo', uploaded_at: '2026-04-05' },
      { id: 'salary', label: 'Justificatif de revenus', name: 'declaracion_renta_2025.pdf', type: 'PDF', size: '2.1 Mo', uploaded_at: '2026-04-05' },
      { id: 'bank', label: 'Relevés bancaires', name: 'extractos_ING.pdf', type: 'PDF', size: '1.8 Mo', uploaded_at: '2026-04-05' },
      { id: 'domicile', label: 'Justificatif de domicile', name: 'recibo_gas.pdf', type: 'PDF', size: '290 Ko', uploaded_at: '2026-04-05' },
      { id: 'rib', label: 'RIB', name: 'IBAN_ING.pdf', type: 'PDF', size: '110 Ko', uploaded_at: '2026-04-05' },
      { id: 'other', label: 'Document complémentaire', name: 'devis_panneaux_solaires.pdf', type: 'PDF', size: '1.5 Mo', uploaded_at: '2026-04-05' },
    ],
    consents: { cgu: true, privacy: true, accuracy: true, processing: true, marketing: true },
    notes: null,
    assigned_advisor: null,
