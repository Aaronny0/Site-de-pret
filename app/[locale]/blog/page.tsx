...
const mainArticle_es = {
  title: "¿Cómo preparar su expediente de hipoteca en 2025?",
  category: "Consejos Inmobiliarios",
  excerpt: "Con la subida de los tipos de interés y el endurecimiento de las normativas, obtener financiación requiere más preparación que antes. Descubra nuestras 5 estrategias.",
  readTime: "7 min",
  author: "Sara L.",
  date: "12 Abril 2025"
};
...
const articles_es = [
  {
    title: "El verdadero coste de una reagrupación de créditos",
    category: "Reagrupación",
    excerpt: "Entender los gastos de cancelación y honorarios antes de lanzarse a una operación de unificación de deudas.",
    readTime: "5 min",
    author: "Marcos D.",
    date: "5 Abril 2025"
  },
  {
    title: "Eficiencia energética: ¿cómo financiar sus obras de rehabilitación?",
    category: "Eco-Renovación",
    excerpt: "Fondos Next Generation, ayudas estatales... panorama completo de subvenciones y préstamos para mejorar el aislamiento térmico.",
    readTime: "8 min",
    author: "Clara M.",
    date: "28 Marzo 2025"
  },
  {
    title: "Pedir un préstamo sin contrato indefinido, ¿aún es posible?",
    category: "Préstamo Personal",
    excerpt: "Autónomos, contratos temporales: ¿qué bancos aceptan su perfil y bajo qué condiciones de viabilidad e interés?",
    readTime: "4 min",
    author: "Sara L.",
    date: "15 Marzo 2025"
  }
...
export default function BlogPage() {
  ...
  const mainArticle = lang === 'fr' ? mainArticle_fr : mainArticle_es;
  const articles = lang === 'fr' ? articles_fr : articles_es;
    ...
    <>
      <section style={{ background: "linear-gradient(135deg, var(--color-primary), var(--color-primary-dark))", padding: "4rem 0 3rem", textAlign: "center" }}>
        <div className="container">
          ...
          <h1 style={{ color: "white", fontFamily: "var(--font-display)", fontSize: "clamp(1.75rem, 4vw, 2.5rem)", marginBottom: "0.75rem" }}>
            {lang === 'fr' ? 'Blog & Conseils Experts' : 'Blog y Consejos Expertos'}
          </h1>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "1.1rem" }}>
            {lang === 'fr' ? "L'actualité financière et nos guides pratiques pour maîtriser votre budget." : "Noticias financieras y nuestras guías prácticas para controlar su presupuesto."}
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "var(--color-bg)", padding: "4rem 0" }}>
        <div className="container">
           ...
           {/* Grille d'articles */}
           <h3 style={{ fontSize: "1.5rem", marginBottom: "2rem" }}>{lang === 'fr' ? 'Derniers articles' : 'Últimos artículos'}</h3>
